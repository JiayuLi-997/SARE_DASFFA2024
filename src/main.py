# -*- coding: UTF-8 -*-
'''
Reference: ReChorus https://github.com/THUwangcy/ReChorus/
'''
...
from models.SARE import *
from models.CARCA import *
from models.Mojito import *
from models.CF_SARE import *
from models.MeanTime import *
...
def main():
    ...
    writer = SummaryWriter("../log/tensorboard_records/%s"%(args.log_file_name))
...
if __name__ == '__main__':
    ...
    args.data_appendix = ''
    if model_name.reader in  ['ContextReader','ContextSeqReader','ImpressionContextReader']:
